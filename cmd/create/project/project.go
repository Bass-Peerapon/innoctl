...
var ProjectCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		templates := map[string][]byte{
			...
			"response/response.go":             templater.Response,
			"middleware/middleware.go":         templater.Middleware,
			"middleware/jwt.go":                templater.JWT,
			"middleware/logger.go":             templater.Logger,
			"middleware/capture.go":            templater.Capture,
			"middleware/openapi.go":            templater.OpenAPI,
			"middleware/tracer.go":             templater.Tracer,
			"middleware/transform_response.go": templater.TransformResponse,
			...
			"utils/helper/env.go":              templater.Env,
			"utils/grpc/grpc.go":               templater.Grpc,
